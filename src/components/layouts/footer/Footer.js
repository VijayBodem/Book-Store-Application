...
const Footer = () => {
    const form = useRef();
    const serviceId = "service_vdberfq";
    const templateId = "template_ce04z8r";
    const publicKey = "7UluUDqJAO176s2bv"
            ...
            <div className="container">
                ...
                <form onSubmit={handleSubmit} ref={form} className="footer-form">
                    ...
                    <label htmlFor="query" className="form-label">Query: </label>
                        <textarea className="form-input" name="message" id="query" placeholder="Type your query" >
